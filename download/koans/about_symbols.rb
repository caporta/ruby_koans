...
class AboutSymbols < Neo::Koan
  ...
  #   Passing in a symbol to `include?` will create a new symbol(object) by that name,
  #   and thus, will always return true.
  ...
  #   You'll be allocating memory to both a string && symbol
end
