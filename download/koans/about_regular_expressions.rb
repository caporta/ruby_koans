...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    #   Never (although the overall expression which included it
    #   could fail if the pattern preceding it did not match).
  end
  ...
  #
  # Why?
  #   Because there's no max delimeter on how many bytes
  #   the operator would allow an expression to return.
  ...
  #   Certain operators take on different meaning (or lose meaning)
  #   within character classes. For example, [.\d] != (.|\d)
